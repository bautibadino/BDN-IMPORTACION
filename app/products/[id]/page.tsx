...
import ProductBatchView from "@/components/products/ProductBatchView"
              ...
              <CardContent className="p-6 space-y-6">
                <div className="space-y-4">
                  ...
                  {product.mlListingUrl && (
                    <div>
                      <p className="text-sm text-gray-600 mb-2">Publicación MercadoLibre</p>
                      <Link
                        href={product.mlListingUrl}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-lg hover:from-yellow-100 hover:to-orange-100 transition-all duration-200 group"
                      >
                        <ExternalLink className="h-4 w-4 text-orange-600 group-hover:scale-110 transition-transform" />
                        <span className="text-orange-700 font-medium">Ver en MercadoLibre</span>
                      </Link>
                    </div>
                  )}
                </div>
