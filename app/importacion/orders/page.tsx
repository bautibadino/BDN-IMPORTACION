      ...
      <CardContent className="pt-0">
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-gray-100">
            <Link href={`/importacion/orders/${order.id}`}>
                ...
                {filteredOrders.map((order) => (
                  <TableRow key={order.id} className="hover:bg-gradient-to-r hover:from-blue-50/30 hover:to-indigo-50/30 transition-all duration-200">
                    <TableCell className="font-medium">
                      <Link href={`/importacion/orders/${order.id}`} className="hover:underline text-blue-600 hover:text-blue-800 transition-colors">
                        {order.orderNumber}
                      </Link>
                    </TableCell>
